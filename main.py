...
def main():
    ...
    print("[3] Run Full Pipeline (Descriptive -> DDM -> Recovery)")
    ...
    if choice == "1":
        ...
        best_model = ddm.run_ddm_analysis(df_phase2)
        ...
        if best_model:
            print("\n" + "-"*40 + "\n")
            print("[PART 3: Parameter Recovery]")
            rec.run_parameter_recovery(best_model)
        else:
            print("Skipping recovery: No model returned.")
