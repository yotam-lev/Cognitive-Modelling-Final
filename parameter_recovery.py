...
# We mimic your real dataset size (approx 5000 trials, split evenly)
# 2. Simulate Synthetic Data
# We mimic your real dataset size (approx 5000 trials, split evenly)
print(f"Simulating synthetic trials...")

# Simulate 2500 trials for Dutch
print(f"Simulating synthetic trials using solve() and resample()...")

# Step 1: Solve the model to get the probability distribution for 'Dutch'
# This calculates the analytical solution
sol_dutch = generator_model.solve(conditions={"distractor_language": "dutch"})

# Step 2: Generate 2500 random trials from that distribution
...
# Step 4: Combine them into one Sample object
...
# We define a "Fittable" model that doesn't know the answers (starts random)
